      ...
      <form id='createSpotForm' onSubmit={handleSubmit}>
        <div id='spotFormInfoContainer'>
          ...
          <div id='locationContainer' className='bottomBorder'>
            ...
            <div id='country-streetAdd-container'>
              ...
              <label className="createSpotLabel streetAdd">
                <p className='streetAddLabel'>Street Address {errors.address && <span className='locationErrors'>{errors.address}</span>}</p>
                <input
                  type='text'
                  placeholder='Address'
                  value={address}
            ...
            <div id='cityStateContainer'>
              <label className="createSpotLabel city">
                <p className='streetAddLabel'>City {errors.city && <span className='locationErrors'>{errors.city}</span>}</p>
                <input
                  type='text'
                  placeholder='City'
                  value={city}
          ...
          <div id='createSpotInfoContainer'>
            ...
            <div id='createSpotTitleContainer' className='bottomBorder'>
              <h2 className='createSpotFormH2'>Update the title for your spot</h2>
          ...
          <div id='createSpotPricing' className='bottomBorder'>
            <h2 className='createSpotFormH2'>Update the price for your spot</h2>
